...
public class MfaWebServices : IMfaWebServices
{
    ...
    public async Task<MfaWsResponse<string>> TokenSistemaAsync(DtoTokenSistemaReq req)
    {
        ...
        return await ReadAsAsync<MfaWsResponse<string>>(resp);
    }

    public async Task<MfaWsResponse<DtoMfaState>> StateAsync(long identificacion, string usuario, string bearer)
    {
        ...
        using var resp = await _http.SendAsync(httpReq, HttpCompletionOption.ResponseHeadersRead);
        return await ReadAsAsync<MfaWsResponse<DtoMfaState>>(resp);
    }

    public async Task<MfaWsResponse<DtoMfaEnrollStartResp>> EnrollStartAsync(DtoMfaEnrollStartReq req, string bearer)
    {
        using var httpReq = BuildJsonRequest(HttpMethod.Post, _urls.MfaEnrollStart!, req, bearer);
        using var resp = await _http.SendAsync(httpReq, HttpCompletionOption.ResponseHeadersRead);
        return await ReadAsAsync<MfaWsResponse<DtoMfaEnrollStartResp>>(resp);
    }

    public async Task<MfaWsResponse<DtoMfaEnrrollConfirmResp>> EnrollConfirmAsync(DtoMfaEnrollConfirmReq req, string bearer)
    {
        using var httpReq = BuildJsonRequest(HttpMethod.Post, _urls.MfaEnrollConfirm!, req, bearer);
        using var resp = await _http.SendAsync(httpReq, HttpCompletionOption.ResponseHeadersRead);
        return await ReadAsAsync<MfaWsResponse<DtoMfaEnrrollConfirmResp>>(resp);
    }

    public async Task<MfaWsResponse<DtoMfaVerifyResp>> VerifyAsync(DtoMfaVerifyReq req, string bearer)
    {
        using var httpReq = BuildJsonRequest(HttpMethod.Post, _urls.MfaVerify!, req, bearer);
        using var resp = await _http.SendAsync(httpReq, HttpCompletionOption.ResponseHeadersRead);
        return await ReadAsAsync<MfaWsResponse<DtoMfaVerifyResp>>(resp);
    }

    public async Task<MfaWsResponse<int>> IsTrustedAsync(long identificacion, string usuario, string deviceId, string bearer)
    {
        ...
        using var httpReq = BuildJsonRequest(HttpMethod.Get, url, body: null, bearer: bearer);
        using var resp = await _http.SendAsync(httpReq, HttpCompletionOption.ResponseHeadersRead);
        return await ReadAsAsync<MfaWsResponse<int>>(resp);
    }

    public async Task<MfaWsResponse<int>> ResetAsync(DtoMfaResetReq req, string bearer)
    {
    ...
    public async Task<MfaWsResponse<int>> ChangeMfaAsync(DtoMfaResetReq req, string bearer)
    {
    ...
    public async Task<MfaWsResponse<int>> TrustClearUserAsync(DtoMfaTrustClearReq req, string bearer)
    {
    ...
    public async Task<MfaWsResponse<int>> ResetRequestAsync(DtoMfaResetRequestReq req, string bearer)
    {
    ...
    public async Task<MfaWsResponse<DtoMfaResetConfirmResp>> ResetConfirmAsync(DtoMfaResetConfirmReq req, string bearer)
    {
        using var httpReq = BuildJsonRequest(HttpMethod.Post, _urls.MfaResetConfirm!, req, bearer);
        using var resp = await _http.SendAsync(httpReq, HttpCompletionOption.ResponseHeadersRead);
        return await ReadAsAsync<MfaWsResponse<DtoMfaResetConfirmResp>>(resp);
    }

    public async Task<MfaWsResponse<int>> ResetExecuteAsync(DtoMfaResetExecuteReq req, string bearer)
    {
