...
namespace Negocio.Interfaz.Control
{
    public interface IDbControlGestion
    {
        ...
        Task<DtoResultado<List<DtoTareaControlGestion>>> F_GetTareasControlGestion(DateTime fechaInicio, DateTime fechaFin, int? regionCodigo, string? siglaUnidad, int? idClase, string rolesUsuario, long codigoUnidad);

        Task<DtoResultado<List<DtoCasoControlGestion>>> F_GetCasosControlGestion(DateTime fechaInicio, DateTime fechaFin, int? regionCodigo, string? siglaUnidad, int? idClase, string rolesUsuario, long codigoUnidad);
        ...
        Task<DtoResultado<List<DtoClaseIrisp1>>> F_GetClasesIrisp1();
        ...
        Task<DtoResultado<List<DtoResultadoCasoIrisp1>>> F_GetResultadosCasosIrisp1(DateTime fechaInicio, DateTime fechaFin, int? regionCodigo, string? siglaUnidad, int? idClase, string rolesUsuario, long codigoUnidad);
    }
}
